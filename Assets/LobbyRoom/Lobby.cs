...
public class Lobby : MonoBehaviourPunCallbacks
{
    ...
    //파이어베이스 관련 변수 (혹시 모르니 png, json 따로 관리)
    ...
    IEnumerator Refresh_MapData()
    {
        while (true)
        {
            ...
            Debug.Log("파일리스트 다운 완료 : " + file_list.Count);
            ...
            for (int i = 0; i < file_list.Count; i++)
            {
                ...
                //id에 .png 나 .json 나면 오류의 소지가 있지만 우선 패스
